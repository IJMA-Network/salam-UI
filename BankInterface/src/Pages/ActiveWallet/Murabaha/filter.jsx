...
export default function Filter({ data }) {
    ...
    function handler() {
        ...
        let filter = datafilter.filter((value) => {
            if (value.agreementDate >= filterissueDate && value.agreementDate <= filterendDate || value.internalReference == filterendref) {
                return (
                    value
                )
            } else if (value.internalReference == filterendref) {
                return (
                    value
                )
            }
             else if (value.borrowerAccountInfo.name == filterendissuer) {
                return (
                    value
                )
            }
