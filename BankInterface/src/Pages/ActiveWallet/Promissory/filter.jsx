...
export default function Filter({ data }) {
    ...
    function handler() {
        ...
        let filter = datafilter.filter((value) => {
            if (value.issueDate >= filterissueDate && value.issueDate <= filterendDate || value.id == filterendref) {
                return (
                    value
                )
            } else if (value.id == filterendref) {
                return (
                    value
                )
            } else if (value.issuerAccount.name == filterendissuer) {
                return (
                    value
                )
            }
