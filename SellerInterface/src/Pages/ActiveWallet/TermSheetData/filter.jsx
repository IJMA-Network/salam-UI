...
export default function Filter({ data }) {
    ...
    function handler() {
        ...
        let filter = datafilter.filter((value) => {
            if (value.issueDate >= filterissueDate && value.issueDate <= filterendDate || value.termSheetReference == filterendref) {
                return (
                    value
                )
            } else if (value.termSheetReference == filterendref) {
                return (
                    value
                )
            } else if (value.bankAccountInfo.name == filterendissuer) {
                return (
                    value
                )
            }
