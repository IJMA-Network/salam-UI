...
export default function Filter({ data }) {
    ...
    function handler() {
        ...
        let filter = datafilter.filter((value) => {
            if (value.date >= filterissueDate && value.date <= filterendDate || value.proformaId == filterendref) {
                return (
                    value
                )
            } else if (value.proformaId == filterendref) {
                return (
                    value
                )
            } else if (value.sellerAccountInfo.name == filterendissuer) {
                return (
                    value
                )
            }
